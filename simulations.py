...
def sc_outage_prob_simulation(Omega_S, Omega_I, P, eta, delta, epsilon_0):
    ...
    P_out_values_2_2 = np.array(
        [sc_outage_probability(L, 2, P, delta, eta, Omega_S, Omega_I, epsilon_0, rho) for rho in rho_values])
    P_out_values_2_4 = np.array(
        [sc_outage_probability(L, 4, P, delta, eta, Omega_S, Omega_I, epsilon_0, rho) for rho in rho_values])
    P_out_values_2_8 = np.array(
        [sc_outage_probability(L, 8, P, delta, eta, Omega_S, Omega_I, epsilon_0, rho) for rho in np.logspace(0, 2.25, 10)])
