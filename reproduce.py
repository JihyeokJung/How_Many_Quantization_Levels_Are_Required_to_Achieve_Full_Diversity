...
def outage_prob_plot(fig_num):
    if fig_num == 1:
        ...
        plt.plot(10 * np.log10(opt_P_out_values_4[0]), opt_P_out_values_4[1], 'm^--')
        ...
        fig_name = "The outage probability with optimal fc phase shift"

        opt_P_out_values_2 = np.load(f"./Curves/FC_opt_outage_prob_2.npy")
        opt_P_out_values_4 = np.load(f"./Curves/FC_opt_outage_prob_4.npy")
        opt_P_out_values_8 = np.load(f"./Curves/FC_opt_outage_prob_8.npy")
